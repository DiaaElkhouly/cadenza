        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Experience the warmth and elegance of our Mono Sparkle Body
      ...
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="flex justify-center">
              <TiltedCard
                ...
                altText="Mono Sparkle Body Splash Product"
        ...
        <div className="bg-emerald-900 text-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-bold mb-4">Sparkle with Elegance</h2>
            <p className="text-xl mb-8">
              Discover the vibrant and refreshing aroma of our Mono Sparkle Body
              Splash.
            </p>
